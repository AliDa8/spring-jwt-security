...
//It represents the business logic of your application.
// → Contains the business logic (rules, processing, calculations).
// Service is the bridge between the Controller and the Repository.
@Service
